...
## 1. Petri Net Relaxation for Infeasibility Explanation and Sequential Task Planning
- **Authors**: Nguyen Cong Nhat Le , John G. Rogers , Claire N. Bonial , Neil T. Dantam
- **URL**: [https://arxiv.org/abs/2602.22094](https://arxiv.org/abs/2602.22094)
- **Abstract**:
...
## 2. Language Models Exhibit Inconsistent Biases Towards Algorithmic Agents and Human Experts
...
## 3. Semantic Partial Grounding via LLMs
...
## 4. 2-Step Agent: A Framework for the Interaction of a Decision Maker with AI Decision Support
- **Authors**: Otto Nyberg , Fausto Carcassi , Giovanni Cinà
- **URL**: [https://arxiv.org/abs/2602.21889](https://arxiv.org/abs/2602.21889)
- **Abstract**:
...
## 5. ProactiveMobile: A Comprehensive Benchmark for Boosting Proactive Intelligence on Mobile Devices
...
## 8. fEDM+: A Risk-Based Fuzzy Ethical Decision Making Framework with Principle-Level Explainability and Pluralistic Validation
- **Authors**: Abeer Dyoub , Francesca A. Lisi
- **URL**: [https://arxiv.org/abs/2602.21746](https://arxiv.org/abs/2602.21746)
- **Abstract**:
...
## 9. The ASIR Courage Model: A Phase-Dynamic Framework for Truth Transitions in Human and AI Systems
- **Authors**: Hyo Jin Kim (Jinple)
- **URL**: [https://arxiv.org/abs/2602.21745](https://arxiv.org/abs/2602.21745)
- **Abstract**:
...
## 10. Power and Limitations of Aggregation in Compound AI Systems
- **Authors**: Nivasini Ananthakrishnan , Meena Jagadeesan
- **URL**: [https://arxiv.org/abs/2602.21556](https://arxiv.org/abs/2602.21556)
- **Abstract**:
...
## 11. ARLArena: A Unified Framework for Stable Agentic Reinforcement Learning
...
## 12. Beyond Refusal: Probing the Limits of Agentic Self-Correction for Semantic Sensitive Information
...
## 13. A Hierarchical Multi-Agent System for Autonomous Discovery in Geoscientific Data Archives
...
## 14. A Dynamic Survey of Soft Set Theory and Its Extensions
- **Authors**: Takaaki Fujita , Florentin Smarandache
- **URL**: [https://arxiv.org/abs/2602.21268](https://arxiv.org/abs/2602.21268)
- **Abstract**:
...
## 15. Recovered in Translation: Efficient Pipeline for Automated Translation of Benchmarks and Datasets
...
## 16. Off-The-Shelf Image-to-Image Models Are All You Need To Defeat Image Protection Schemes
- **Authors**: Xavier Pleimling , Sifat Muhammad Abdullah , Gunjan Balde , Peng Gao , Mainack Mondal , Murtuza Jadliwala , Bimal Viswanath
- **URL**: [https://arxiv.org/abs/2602.22197](https://arxiv.org/abs/2602.22197)
- **Abstract**:
...
## 17. GUI-Libra: Training Native GUI Agents to Reason and Act with Action-aware Supervision and Partially Verifiable RL
...
- **URL**: [https://arxiv.org/abs/2602.22190](https://arxiv.org/abs/2602.22190)
- **Abstract**:
...
## 18. Surrogate models for Rock-Fluid Interaction: A Grid-Size-Invariant Approach
- **Authors**: Nathalie C. Pinheiro , Donghu Guo , Hannah P. Menke , Aniket C. Joshi , Claire E. Heaney , Ahmed H. ElSheikh , Christopher C. Pain
- **URL**: [https://arxiv.org/abs/2602.22188](https://arxiv.org/abs/2602.22188)
- **Abstract**:
...
## 19. Enhancing Framingham Cardiovascular Risk Score Transparency through Logic-Based XAI
- **Authors**: Emannuel L. de A. Bezerra , Luiz H. T. Viana , Vinícius P. Chagas , Diogo E. Rolim , Thiago Alves Rocha , Carlos H. L. Cavalcante
- **URL**: [https://arxiv.org/abs/2602.22149](https://arxiv.org/abs/2602.22149)
- **Abstract**:
...
## 20. Provable Last-Iterate Convergence for Multi-Objective Safe LLM Alignment via Optimistic Primal-Dual
...
## 21. When AI Writes, Whose Voice Remains? Quantifying Cultural Marker Erasure Across World English Varieties in Large Language Models
...
## 22. NoLan: Mitigating Object Hallucinations in Large Vision-Language Models via Dynamic Suppression of Language Priors
...
## 23. SWE-Protégé: Learning to Selectively Collaborate With an Expert Unlocks Small Language Models as Software Engineering Agents
...
## 24. Don't stop me now: Rethinking Validation Criteria for Model Parameter Selection
- **Authors**: Andrea Apicella , Francesco Isgrò , Andrea Pollastro , Roberto Prevete
- **URL**: [https://arxiv.org/abs/2602.22107](https://arxiv.org/abs/2602.22107)
- **Abstract**:
...
## 25. On Imbalanced Regression with Hoeffding Trees
- **Authors**: Pantia-Marina Alchirch , Dimitrios I. Diochnos
- **URL**: [https://arxiv.org/abs/2602.22101](https://arxiv.org/abs/2602.22101)
- **Abstract**:
...
## 26. Understanding Artificial Theory of Mind: Perturbed Tasks and Reasoning in Large Language Models
...
## 27. DualWeaver: Synergistic Feature Weaving Surrogates for Multivariate Forecasting with Univariate Time Series Foundation Models
- **Authors**: Jinpeng Li , Zhongyi Pei , Huaze Xue , Bojian Zheng , Chen Wang , Jianmin Wang
- **URL**: [https://arxiv.org/abs/2602.22066](https://arxiv.org/abs/2602.22066)
- **Abstract**:
...
## 28. NESTOR: A Nested MOE-based Neural Operator for Large-Scale PDE Pre-Training
- **Authors**: Dengdi Sun , Xiaoya Zhou , Xiao Wang , Hao Si , Wanli Lyu , Jin Tang , Bin Luo
- **URL**: [https://arxiv.org/abs/2602.22059](https://arxiv.org/abs/2602.22059)
- **Abstract**:
...
## 29. Physics-Informed Machine Learning for Vessel Shaft Power and Fuel Consumption Prediction: Interpretable KAN-based Approach
- **Authors**: Hamza Haruna Mohammed , Dusica Marijan , Arnbjørn Maressa
- **URL**: [https://arxiv.org/abs/2602.22055](https://arxiv.org/abs/2602.22055)
- **Abstract**:
...
## 30. TG-ASR: Translation-Guided Learning with Parallel Gated Cross Attention for Low-Resource Automatic Speech Recognition
- **Authors**: Cheng-Yeh Yang , Chien-Chun Wang , Li-Wei Chen , Hung-Shin Lee , Hsin-Min Wang , Berlin Chen
- **URL**: [https://arxiv.org/abs/2602.22039](https://arxiv.org/abs/2602.22039)
- **Abstract**:
...
- **URL**: [https://arxiv.org/abs/2602.22026](https://arxiv.org/abs/2602.22026)
- **Abstract**:
...
## 32. Enhancing LLM-Based Test Generation by Eliminating Covered Code
...
## 33. PatchDenoiser: Parameter-efficient multi-scale patch learning and fusion denoiser for medical images
- **Authors**: Jitindra Fartiyal , Pedro Freire , Sergei K. Turitsyn , Sergei G. Solovski
- **URL**: [https://arxiv.org/abs/2602.21987](https://arxiv.org/abs/2602.21987)
- **Abstract**:
...
## 34. Hidden Topics: Measuring Sensitive AI Beliefs with List Experiments
...
## 35. A Framework for Cross-Domain Generalization in Coronary Artery Calcium Scoring Across Gated and Non-Gated Computed Tomography
...
- **URL**: [https://arxiv.org/abs/2602.21935](https://arxiv.org/abs/2602.21935)
- **Abstract**:
...
## 36. DynamicGTR: Leveraging Graph Topology Representation Preferences to Boost VLM Capabilities on Graph QAs
...
## 37. Understanding Annotation Error Propagation and Learning an Adaptive Policy for Expert Intervention in Barrett's Video Segmentation
- **Authors**: Lokesha Rasanjalee , Jin Lin Tan , Dileepa Pitawela , Rajvinder Singh , Hsiang-Ting Chen
- **URL**: [https://arxiv.org/abs/2602.21855](https://arxiv.org/abs/2602.21855)
- **Abstract**:
...
## 38. xai-cola: A Python library for sparsifying counterfactual explanations
- **Authors**: Lin Zhu , Lei You
- **URL**: [https://arxiv.org/abs/2602.21845](https://arxiv.org/abs/2602.21845)
- **Abstract**:
...
## 39. Resilient Federated Chain: Transforming Blockchain Consensus into an Active Defense Layer for Federated Learning
- **Authors**: Mario García-Márquez , Nuria Rodríguez-Barroso , M.Victoria Luzón , Francisco Herrera
- **URL**: [https://arxiv.org/abs/2602.21841](https://arxiv.org/abs/2602.21841)
- **Abstract**:
...
## 40. StoryMovie: A Dataset for Semantic Alignment of Visual Stories with Movie Scripts and Subtitles
- **Authors**: Daniel Oliveira , David Martins de Matos
- **URL**: [https://arxiv.org/abs/2602.21829](https://arxiv.org/abs/2602.21829)
- **Abstract**:
...
## 41. SemVideo: Reconstructs What You Watch from Brain Activity via Hierarchical Semantic Guidance
- **Authors**: Minghan Yang , Lan Yang , Ke Li , Honggang Zhang , Kaiyue Pang , Yizhe Song
- **URL**: [https://arxiv.org/abs/2602.21819](https://arxiv.org/abs/2602.21819)
- **Abstract**:
...
## 42. An Evaluation of Context Length Extrapolation in Long Code via Positional Embeddings and Efficient Attention
...
## 43. Excitation: Momentum For Experts
- **Authors**: Sagi Shaier
- **URL**: [https://arxiv.org/abs/2602.21798](https://arxiv.org/abs/2602.21798)
- **Abstract**:
...
## 44. Beyond Static Artifacts: A Forensic Benchmark for Video Deepfake Reasoning in Vision Language Models
...
## 45. UniWhisper: Efficient Continual Multi-task Training for Robust Universal Audio Representation
- **Authors**: Yuxuan Chen , Peize He , Haoyuan Xu , Junzi Zhang
- **URL**: [https://arxiv.org/abs/2602.21772](https://arxiv.org/abs/2602.21772)
- **Abstract**:
...
## 46. Generalisation of RLHF under Reward Shift and Clipped KL Regularisation
...
## 47. Learning from Yesterday's Error: An Efficient Online Learning Method for Traffic Demand Prediction
- **Authors**: Xiannan Huang , Quan Yuan , Chao Yang
- **URL**: [https://arxiv.org/abs/2602.21757](https://arxiv.org/abs/2602.21757)
- **Abstract**:
...
## 48. Evaluating the relationship between regularity and learnability in recursive numeral systems using Reinforcement Learning
- **Authors**: Andrea Silvi , Ponrawee Prasertsom , Jennifer Culbertson , Devdatt Dubhashi , Moa Johansson , Kenny Smith
- **URL**: [https://arxiv.org/abs/2602.21720](https://arxiv.org/abs/2602.21720)
- **Abstract**:
...
## 49. Two-Stage Active Distribution Network Voltage Control via LLM-RL Collaboration: A Hybrid Knowledge-Data-Driven Approach
...
## 50. SurGo-R1: Benchmarking and Modeling Contextual Reasoning for Operative Zone in Surgical Video
...
## 51. Dynamic Multimodal Activation Steering for Hallucination Mitigation in Large Vision-Language Models
...
## 52. Hierarchical LLM-Based Multi-Agent Framework with Prompt Optimization for Multi-Robot Task Planning
...
## 53. Following the Diagnostic Trace: Visual Cognition-guided Cooperative Network for Chest X-Ray Diagnosis
- **Authors**: Shaoxuan Wu , Jingkun Chen , Chong Ma , Cong Shen , Xiao Zhang , Jun Feng
- **URL**: [https://arxiv.org/abs/2602.21657](https://arxiv.org/abs/2602.21657)
- **Abstract**:
...
## 54. CCCaption: Dual-Reward Reinforcement Learning for Complete and Correct Image Captioning
- **Authors**: Zhijiang Tang , Linhua Wang , Jiaxin Qi , Weihao Jiang , Peng Hou , Anxiang Zeng , Jianqiang Huang
- **URL**: [https://arxiv.org/abs/2602.21655](https://arxiv.org/abs/2602.21655)
- **Abstract**:
...
## 55. Sparsity Induction for Accurate Post-Training Pruning of Large Language Models
...
## 56. PPCR-IM: A System for Multi-layer DAG-based Public Policy Consequence Reasoning and Social Indicator Mapping
...
## 57. Mitigating Structural Noise in Low-Resource S2TT: An Optimized Cascaded Nepali-English Pipeline with Punctuation Restoration
- **Authors**: Tangsang Chongbang , Pranesh Pyara Shrestha , Amrit Sarki , Anku Jaiswal
- **URL**: [https://arxiv.org/abs/2602.21647](https://arxiv.org/abs/2602.21647)
- **Abstract**:
...
## 58. Self-Correcting VLA: Online Action Refinement via Sparse World Imagination
- **Authors**: Chenyv Liu , Wentao Tan , Lei Zhu , Fengling Li , Jingjing Li , Guoli Yang , Heng Tao Shen
- **URL**: [https://arxiv.org/abs/2602.21633](https://arxiv.org/abs/2602.21633)
- **Abstract**:
...
## 59. Virtual Biopsy for Intracranial Tumors Diagnosis on MRI
...
## 60. Structurally Aligned Subtask-Level Memory for Software Engineering Agents
...
## 61. Retrieval Challenges in Low-Resource Public Service Information: A Case Study on Food Pantry Access
- **Authors**: Touseef Hasan , Laila Cure , Souvika Sarkar
- **URL**: [https://arxiv.org/abs/2602.21598](https://arxiv.org/abs/2602.21598)
- **Abstract**:
...
## 62. Exploring Human-Machine Coexistence in Symmetrical Reality
- **Authors**: Zhenliang Zhang
- **URL**: [https://arxiv.org/abs/2602.21584](https://arxiv.org/abs/2602.21584)
- **Abstract**:
...
## 63. Revisiting RAG Retrievers: An Information Theoretic Benchmark
...
## 64. From Basis to Basis: Gaussian Particle Representation for Interpretable PDE Operators
- **Authors**: Zhihao Li , Yu Feng , Zhilu Lai , Wei Wang
- **URL**: [https://arxiv.org/abs/2602.21551](https://arxiv.org/abs/2602.21551)
- **Abstract**:
...
## 65. Enhancing Multilingual Embeddings via Multi-Way Parallel Text Alignment
- **Authors**: Barah Fazili , Koustava Goswami
- **URL**: [https://arxiv.org/abs/2602.21543](https://arxiv.org/abs/2602.21543)
- **Abstract**:
...
## 66. LiLo-VLA: Compositional Long-Horizon Manipulation via Linked Object-Centric Policies
- **Authors**: Yue Yang , Shuo Cheng , Yu Fang , Homanga Bharadhwaj , Mingyu Ding , Gedas Bertasius , Daniel Szafir
- **URL**: [https://arxiv.org/abs/2602.21531](https://arxiv.org/abs/2602.21531)
- **Abstract**:
...
## 67. One Brain, Omni Modalities: Towards Unified Non-Invasive Brain Decoding with Large Language Models
...
## 68. Training Generalizable Collaborative Agents via Strategic Risk Aversion
...
## 69. GradAlign: Gradient-Aligned Data Selection for LLM Reinforcement Learning
...
## 70. A Knowledge-Driven Approach to Music Segmentation, Music Source Separation and Cinematic Audio Source Separation
- **Authors**: Chun-wei Ho , Sabato Marco Siniscalchi , Kai Li , Chin-Hui Lee
- **URL**: [https://arxiv.org/abs/2602.21476](https://arxiv.org/abs/2602.21476)
- **Abstract**:
...
## 71. Revisiting Text Ranking in Deep Research
...
## 72. Adversarial Robustness of Deep Learning-Based Thyroid Nodule Segmentation in Ultrasound
- **Authors**: Nicholas Dietrich , David McShannon
- **URL**: [https://arxiv.org/abs/2602.21452](https://arxiv.org/abs/2602.21452)
- **Abstract**:
...
## 73. Adversarial Intent is a Latent Variable: Stateful Trust Inference for Securing Multimodal Agentic RAG
...
## 74. MINAR: Mechanistic Interpretability for Neural Algorithmic Reasoning
...
## 75. Causal Decoding for Hallucination-Resistant Multimodal Large Language Models
...
## 76. Provably Safe Generative Sampling with Constricting Barrier Functions
- **Authors**: Darshan Gadginmath , Ahmed Allibhoy , Fabio Pasqualetti
- **URL**: [https://arxiv.org/abs/2602.21429](https://arxiv.org/abs/2602.21429)
- **Abstract**:
...
## 77. On the Structural Non-Preservation of Epistemic Behaviour under Policy Transformation
- **Authors**: Alexander Galozy
- **URL**: [https://arxiv.org/abs/2602.21424](https://arxiv.org/abs/2602.21424)
- **Abstract**:
...
## 78. ECHOSAT: Estimating Canopy Height Over Space And Time
...
- **URL**: [https://arxiv.org/abs/2602.21421](https://arxiv.org/abs/2602.21421)
- **Abstract**:
...
## 79. Overconfident Errors Need Stronger Correction: Asymmetric Confidence Penalties for Reinforcement Learning
...
## 80. The Headless Firm: How AI Reshapes Enterprise Boundaries
- **Authors**: Tassilo Klein , Sebastian Wieczorek
- **URL**: [https://arxiv.org/abs/2602.21401](https://arxiv.org/abs/2602.21401)
- **Abstract**:
...
## 81. FedVG: Gradient-Guided Aggregation for Enhanced Federated Learning
- **Authors**: Alina Devkota , Jacob Thrasher , Donald Adjeroh , Binod Bhattarai , Prashnna K. Gyawali
- **URL**: [https://arxiv.org/abs/2602.21399](https://arxiv.org/abs/2602.21399)
- **Abstract**:
...
## 82. VCDF: A Validated Consensus-Driven Framework for Time Series Causal Discovery
- **Authors**: Gene Yu , Ce Guo , Wayne Luk
- **URL**: [https://arxiv.org/abs/2602.21381](https://arxiv.org/abs/2602.21381)
- **Abstract**:
...
## 83. MrBERT: Modern Multilingual Encoders via Vocabulary, Domain, and Dimensional Adaptation
...
- **URL**: [https://arxiv.org/abs/2602.21379](https://arxiv.org/abs/2602.21379)
- **Abstract**:
...
## 84. Small Language Models for Privacy-Preserving Clinical Information Extraction in Low-Resource Languages
...
## 85. The Mean is the Mirage: Entropy-Adaptive Model Merging under Heterogeneous Domain Shifts in Medical Imaging
- **Authors**: Sameer Ambekar , Reza Nasirigerdeh , Peter J. Schuffler , Lina Felsner , Daniel M. Lang , Julia A. Schnabel
- **URL**: [https://arxiv.org/abs/2602.21372](https://arxiv.org/abs/2602.21372)
- **Abstract**:
...
## 86. Black-Box Reliability Certification for AI Agents via Self-Consistency Sampling and Conformal Calibration
- **Authors**: Charafeddine Mouzouni
- **URL**: [https://arxiv.org/abs/2602.21368](https://arxiv.org/abs/2602.21368)
- **Abstract**:
...
## 87. Towards Controllable Video Synthesis of Routine and Rare OR Events
...
- **URL**: [https://arxiv.org/abs/2602.21365](https://arxiv.org/abs/2602.21365)
- **Abstract**:
...
## 88. Towards single-shot coherent imaging via overlap-free ptychography
- **Authors**: Oliver Hoidn , Aashwin Mishra , Steven Henke , Albert Vong , Matthew Seaberg
- **URL**: [https://arxiv.org/abs/2602.21361](https://arxiv.org/abs/2602.21361)
- **Abstract**:
...
## 89. Representation Theorems for Cumulative Propositional Dependence Logics
- **Authors**: Juha Kontinen , Arne Meier , Kai Sauerwald
- **URL**: [https://arxiv.org/abs/2602.21360](https://arxiv.org/abs/2602.21360)
- **Abstract**:
...
## 90. Alignment-Weighted DPO: A principled reasoning approach to improve safety alignment
...
## 91. Scaling View Synthesis Transformers
- **Authors**: Evan Kim , Hyunwoo Ryu , Thomas W. Mitchel , Vincent Sitzmann
- **URL**: [https://arxiv.org/abs/2602.21341](https://arxiv.org/abs/2602.21341)
- **Abstract**:
...
## 92. Equitable Evaluation via Elicitation
...
## 93. Group Orthogonalized Policy Optimization:Group Policy Optimization as Orthogonal Projection in Hilbert Space
- **Authors**: Wang Zixian
...
## 94. A Systematic Review of Algorithmic Red Teaming Methodologies for Assurance and Security of AI Applications
- **Authors**: Shruti Srivastava , Kiranmayee Janardhan , Shaurya Jauhari
- **URL**: [https://arxiv.org/abs/2602.21267](https://arxiv.org/abs/2602.21267)
- **Abstract**:
...
## 95. A General Equilibrium Theory of Orchestrated AI Agent Systems
...
## 96. AgenticTyper: Automated Typing of Legacy Software Projects Using Agentic AI
...
## 97. AngelSlim: A more accessible, comprehensive, and efficient toolkit for large model compression
...
- **URL**: [https://arxiv.org/abs/2602.21233](https://arxiv.org/abs/2602.21233)
- **Abstract**:
...
## 98. Urban Vibrancy Embedding and Application on Traffic Prediction
- **Authors**: Sumin Han , Jisun An , Dongman Lee
- **URL**: [https://arxiv.org/abs/2602.21232](https://arxiv.org/abs/2602.21232)
- **Abstract**:
...
## 99. ACAR: Adaptive Complexity Routing for Multi-Model Ensembles with Auditable Decision Traces
- **Authors**: Ramchand Kumaresan
- **URL**: [https://arxiv.org/abs/2602.21231](https://arxiv.org/abs/2602.21231)
- **Abstract**:
...
## 100. ImpRIF: Stronger Implicit Reasoning Leads to Better Complex Instruction Following
...
## 101. Budget-Aware Agentic Routing via Boundary-Guided Training
...
## 102. IslamicLegalBench: Evaluating LLMs Knowledge and Reasoning of Islamic Law Across 1,200 Years of Islamic Pluralist Legal Traditions
- **Authors**: Ezieddin Elmahjub , Junaid Qadir , Abdullah Mushtaq , Rafay Naeem , Ibrahim Ghaznavi , Waleed Iqbal
- **URL**: [https://arxiv.org/abs/2602.21226](https://arxiv.org/abs/2602.21226)
- **Abstract**:
...
## 103. Architecture-Agnostic Curriculum Learning for Document Understanding: Empirical Evidence from Text-Only and Multimodal
- **Authors**: Mohammed Hamdan , Vincenzo Dentamaro , Giuseppe Pirlo , Mohamed Cheriet
- **URL**: [https://arxiv.org/abs/2602.21225](https://arxiv.org/abs/2602.21225)
- **Abstract**:
...
## 104. Make Every Draft Count: Hidden State based Speculative Decoding
...
## 105. Measuring Pragmatic Influence in Large Language Model Instructions
...
## 106. Task-Aware LoRA Adapter Composition via Similarity Retrieval in Vector Databases
...
## 107. Latent Context Compilation: Distilling Long Context into Compact Portable Memory
...
## 108. Field-Theoretic Memory for AI Agents: Continuous Dynamics for Context Preservation
- **Authors**: Subhadip Mitra
- **URL**: [https://arxiv.org/abs/2602.21220](https://arxiv.org/abs/2602.21220)
- **Abstract**:
...
## 109. Reasoning-Based Personalized Generation for Users with Sparse Data
...
## 110. EPSVec: Efficient and Private Synthetic Data Generation via Dataset Vectors
...
## 111. Applied Sociolinguistic AI for Community Development (ASA-CD): A New Scientific Paradigm for Linguistically-Grounded Social Intervention
- **Authors**: S M Ruhul Alam , Rifa Ferzana
- **URL**: [https://arxiv.org/abs/2602.21217](https://arxiv.org/abs/2602.21217)
- **Abstract**:
...
## 112. EQ-5D Classification Using Biomedical Entity-Enriched Pre-trained Language Models and Multiple Instance Learning
...
## 113. Inference-time Alignment via Sparse Junction Steering
