...
## 3. A Multi-Objective Genetic Algorithm for Healthcare Workforce Scheduling
- **Authors**: Vipul Patel, Anirudh Deodhar, Dagnachew Birru
- **URL**: [https://arxiv.org/abs/2508.20953](https://arxiv.org/abs/2508.20953)
- **Abstract**:
...
## 4. A Graph-Based Test-Harness for LLM Evaluation
...
## 5. Single Agent Robust Deep Reinforcement Learning for Bus Fleet Control
- **Authors**: Yifan Zhang
- **URL**: [https://arxiv.org/abs/2508.20784](https://arxiv.org/abs/2508.20784)
- **Abstract**:
...
## 6. Re4: Scientific Computing Agent with Rewriting, Resolution, Review and Revision
...
## 7. Transparent Semantic Spaces: A Categorical Approach to Explainable Word Embeddings
...
- **URL**: [https://arxiv.org/abs/2508.20701](https://arxiv.org/abs/2508.20701)
- **Abstract**:
...
## 8. Bridging Minds and Machines: Toward an Integration of AI and Cognitive Science
- **Authors**: Rui Mao, Qian Liu, Xiao Li, Erik Cambria, Amir Hussain
- **URL**: [https://arxiv.org/abs/2508.20674](https://arxiv.org/abs/2508.20674)
- **Abstract**:
...
## 9. Human-AI Collaborative Bot Detection in MMORPGs
...
## 10. Enhancing Health Fact-Checking with LLM-Generated Synthetic Data
...
## 11. Governable AI: Provable Safety Under Extreme Threat Models
- **Authors**: Donglin Wang, Weiyun Liang, Chunyuan Chen, Jing Xu, Yulong Fu
- **URL**: [https://arxiv.org/abs/2508.20411](https://arxiv.org/abs/2508.20411)
- **Abstract**:
...
## 12. AWorld: Orchestrating the Training Recipe for Agentic AI
...
- **URL**: [https://arxiv.org/abs/2508.20404](https://arxiv.org/abs/2508.20404)
- **Abstract**:
...
## 13. Uncertainty Under the Curve: A Sequence-Level Entropy Area Metric for Reasoning LLM
...
## 14. TCIA: A Task-Centric Instruction Augmentation Method for Instruction Finetuning
...
## 15. P2C: Path to Counterfactuals
- **Authors**: Sopam Dasgupta, Sadaf MD Halim, Joaquín Arias, Elmer Salazar, Gopal Gupta
- **URL**: [https://arxiv.org/abs/2508.20371](https://arxiv.org/abs/2508.20371)
- **Abstract**:
...
## 16. AI-SearchPlanner: Modular Agentic Search via Pareto-Optimal Multi-Objective Reinforcement Learning
...
## 17. AI reasoning effort mirrors human decision time on content moderation tasks
...
## 18. Do Students Rely on AI? Analysis of Student-ChatGPT Conversations from a Field Study
...
- **URL**: [https://arxiv.org/abs/2508.20244](https://arxiv.org/abs/2508.20244)
- **Abstract**:
...
## 19. AI-AI Esthetic Collaboration with Explicit Semiotic Awareness and Emergent Grammar Development
...
## 20. IntentionReasoner: Facilitating Adaptive LLM Safeguards through Intent Reasoning and Selective Query Refinement
...
## 21. The Anatomy of a Personal Health Agent
...
## 22. Array-Based Monte Carlo Tree Search
- **Authors**: James Ragan, Fred Y. Hadaegh, Soon-Jo Chung
- **URL**: [https://arxiv.org/abs/2508.20140](https://arxiv.org/abs/2508.20140)
- **Abstract**:
...
## 23. QAgent: An LLM-based Multi-Agent System for Autonomous OpenQASM programming
...
## 24. ArgRAG: Explainable Retrieval Augmented Generation using Quantitative Bipolar Argumentation
...
## 25. Prompt-to-Product: Generative Assembly via Bimanual Manipulation
...
- **URL**: [https://arxiv.org/abs/2508.21063](https://arxiv.org/abs/2508.21063)
- **Abstract**:
...
## 26. OnGoal: Tracking and Visualizing Conversational Goals in Multi-Turn Dialogue with Large Language Models
...
## 27. Mixture of Contexts for Long Video Generation
...
- **URL**: [https://arxiv.org/abs/2508.21058](https://arxiv.org/abs/2508.21058)
- **Abstract**:
...
## 28. FakeParts: a New Family of AI-Generated DeepFakes
- **Authors**: Gaetan Brison, Soobash Daiboo, Samy Aimeur, Awais Hussain Sani, Xi Wang, Gianni Franchi, Vicky Kalogeiton
- **URL**: [https://arxiv.org/abs/2508.21052](https://arxiv.org/abs/2508.21052)
- **Abstract**:
...
## 29. Enabling Equitable Access to Trustworthy Financial Reasoning
...
## 30. Veritas: Generalizable Deepfake Detection via Pattern-Aware Reasoning
...
## 31. Understanding, Protecting, and Augmenting Human Cognition with Generative AI: A Synthesis of the CHI 2025 Tools for Thought Workshop
...
- **URL**: [https://arxiv.org/abs/2508.21036](https://arxiv.org/abs/2508.21036)
- **Abstract**:
...
## 32. Inference-Time Alignment Control for Diffusion Models with Reinforcement Learning Guidance
...
## 33. ChainReaction! Structured Approach with Causal Chains as Intermediate Representations for Improved and Explainable Causal Video Question Answering
...
## 34. Train-Once Plan-Anywhere Kinodynamic Motion Planning via Diffusion Trees
- **Authors**: Yaniv Hassidof, Tom Jurgenson, Kiril Solovey
- **URL**: [https://arxiv.org/abs/2508.21001](https://arxiv.org/abs/2508.21001)
- **Abstract**:
...
## 35. ExpertSim: Fast Particle Detector Simulation Using Mixture-of-Generative-Experts
- **Authors**: Patryk Będkowski, Jan Dubiński, Filip Szatkowski, Kamil Deja, Przemysław Rokita, Tomasz Trzciński
- **URL**: [https://arxiv.org/abs/2508.20991](https://arxiv.org/abs/2508.20991)
- **Abstract**:
...
## 36. WoW-Bench: Evaluating Fine-Grained Acoustic Perception in Audio-Language Models via Marine Mammal Vocalizations
...
## 37. ProactiveEval: A Unified Evaluation Framework for Proactive Dialogue Agents
...
## 38. Research Challenges in Relational Database Management Systems for LLM Queries
...
## 39. Quantum Verifiable Rewards for Post-Training Qiskit Code Assistant
- **Authors**: Nicolas Dupuis, Adarsh Tiwari, Youssef Mroueh, David Kremer, Ismael Faro, Juan Cruz-Benito
- **URL**: [https://arxiv.org/abs/2508.20907](https://arxiv.org/abs/2508.20907)
- **Abstract**:
...
## 40. AI Agentic Vulnerability Injection And Transformation with Optimized Reasoning
- **Authors**: Amine Lbath, Massih-Reza Amini, Aurelien Delaitre, Vadim Okun
- **URL**: [https://arxiv.org/abs/2508.20866](https://arxiv.org/abs/2508.20866)
- **Abstract**:
...
## 41. JADES: A Universal Framework for Jailbreak Assessment via Decompositional Scoring
- **Authors**: Junjie Chu, Mingjie Li, Ziqing Yang, Ye Leng, Chenhao Lin, Chao Shen, Michael Backes, Yun Shen, Yang Zhang
- **URL**: [https://arxiv.org/abs/2508.20848](https://arxiv.org/abs/2508.20848)
- **Abstract**:
...
## 42. Learning Primitive Embodied World Models: Towards Scalable Robotic Learning
...
## 44. Uncertainty Aware-Predictive Control Barrier Functions: Safer Human Robot Interaction through Probabilistic Motion Forecasting
...
- **URL**: [https://arxiv.org/abs/2508.20812](https://arxiv.org/abs/2508.20812)
- **Abstract**:
...
## 45. Exploring Machine Learning and Language Models for Multimodal Depression Detection
...
## 46. Speech Emotion Recognition via Entropy-Aware Score Selection
- **Authors**: ChenYi Chua, JunKai Wong, Chengxin Chen, Xiaoxiao Miao
- **URL**: [https://arxiv.org/abs/2508.20796](https://arxiv.org/abs/2508.20796)
- **Abstract**:
...
## 47. Surfel-based 3D Registration with Equivariant SE(3) Features
- **Authors**: Xueyang Kang, Hang Zhao, Kourosh Khoshelham, Patrick Vandewalle
- **URL**: [https://arxiv.org/abs/2508.20789](https://arxiv.org/abs/2508.20789)
- **Abstract**:
...
## 48. Evaluating Compositional Generalisation in VLMs and Diffusion Models
...
## 49. Safer Skin Lesion Classification with Global Class Activation Probability Map Evaluation and SafeML
- **Authors**: Kuniko Paxton, Koorosh Aslansefat, Amila Akagić, Dhavalkumar Thakker, Yiannis Papadopoulos
- **URL**: [https://arxiv.org/abs/2508.20776](https://arxiv.org/abs/2508.20776)
- **Abstract**:
...
## 50. Unleashing Uncertainty: Efficient Machine Unlearning for Generative AI
- **Authors**: Christoforos N. Spartalis, Theodoros Semertzidis, Petros Daras, Efstratios Gavves
- **URL**: [https://arxiv.org/abs/2508.20773](https://arxiv.org/abs/2508.20773)
- **Abstract**:
...
## 51. Signs of Struggle: Spotting Cognitive Distortions across Language and Register
- **Authors**: Abhishek Kuber, Enrico Liscio, Ruixuan Zhang, Caroline Figueroa, Pradeep K. Murukannaiah
- **URL**: [https://arxiv.org/abs/2508.20771](https://arxiv.org/abs/2508.20771)
- **Abstract**:
...
## 52. Turning the Spell Around: Lightweight Alignment Amplification via Rank-One Safety Injection
...
## 53. Looking Beyond the Obvious: A Survey on Abstract Concept Recognition for Video Understanding
- **Authors**: Gowreesh Mago, Pascal Mettes, Stevan Rudinac
- **URL**: [https://arxiv.org/abs/2508.20765](https://arxiv.org/abs/2508.20765)
- **Abstract**:
...
## 54. SKGE-SWIN: End-To-End Autonomous Vehicle Waypoint Prediction and Navigation Using Skip Stage Swin Transformer
- **Authors**: Fachri Najm Noer Kartiman, Rasim, Yaya Wihardi, Nurul Hasanah, Oskar Natan, Bambang Wahono, Taufik Ibnu Salim
- **URL**: [https://arxiv.org/abs/2508.20762](https://arxiv.org/abs/2508.20762)
- **Abstract**:
...
## 55. Occlusion Robustness of CLIP for Military Vehicle Classification
...
## 56. SeqVLM: Proposal-Guided Multi-View Sequences Reasoning via VLM for Zero-Shot 3D Visual Grounding
- **Authors**: Jiawen Lin, Shiran Bian, Yihang Zhu, Wenbin Tan, Yachao Zhang, Yuan Xie, Yanyun Qu
- **URL**: [https://arxiv.org/abs/2508.20758](https://arxiv.org/abs/2508.20758)
- **Abstract**:
...
## 57. Provable Benefits of In-Tool Learning for Large Language Models
...
## 58. ${C}^{3}$-GS: Learning Context-aware, Cross-dimension, Cross-scale Feature for Generalizable Gaussian Splatting
- **Authors**: Yuxi Hu, Jun Zhang, Kuangyi Chen, Zhe Zhang, Friedrich Fraundorfer
- **URL**: [https://arxiv.org/abs/2508.20754](https://arxiv.org/abs/2508.20754)
- **Abstract**:
...
## 59. Rethinking Testing for LLM Applications: Characteristics, Challenges, and a Lightweight Interaction Protocol
...
## 60. EEGDM: Learning EEG Representation with Latent Diffusion Model
- **Authors**: Shaocong Wang, Tong Liu, Ming Li, Minjing Yu, Yong-Jin Liu
- **URL**: [https://arxiv.org/abs/2508.20705](https://arxiv.org/abs/2508.20705)
- **Abstract**:
...
## 61. Generative Annotation for ASR Named Entity Correction
...
- **URL**: [https://arxiv.org/abs/2508.20700](https://arxiv.org/abs/2508.20700)
- **Abstract**:
...
## 62. MobileCLIP2: Improving Multi-Modal Reinforced Training
- **Authors**: Fartash Faghri, Pavan Kumar Anasosalu Vasu, Cem Koc, Vaishaal Shankar, Alexander Toshev, Oncel Tuzel, Hadi Pouransari
- **URL**: [https://arxiv.org/abs/2508.20691](https://arxiv.org/abs/2508.20691)
- **Abstract**:
...
## 63. Task Allocation for Autonomous Machines using Computational Intelligence and Deep Reinforcement Learning
- **Authors**: Thanh Thi Nguyen, Quoc Viet Hung Nguyen, Jonathan Kua, Imran Razzak, Dung Nguyen, Saeid Nahavandi
- **URL**: [https://arxiv.org/abs/2508.20688](https://arxiv.org/abs/2508.20688)
- **Abstract**:
...
## 64. Amadeus: Autoregressive Model with Bidirectional Attribute Modelling for Symbolic Music
- **Authors**: Hongju Su, Ke Li, Lan Yang, Honggang Zhang, Yi-Zhe Song
- **URL**: [https://arxiv.org/abs/2508.20665](https://arxiv.org/abs/2508.20665)
- **Abstract**:
...
## 65. Task-Oriented Edge-Assisted Cross-System Design for Real-Time Human-Robot Interaction in Industrial Metaverse
- **Authors**: Kan Chen, Zhen Meng, Xiangmin Xu, Jiaming Yang, Emma Li, Philip G. Zhao
- **URL**: [https://arxiv.org/abs/2508.20664](https://arxiv.org/abs/2508.20664)
- **Abstract**:
...
## 66. GDS Agent: A Graph Algorithmic Reasoning Agent
...
## 67. ArtFace: Towards Historical Portrait Face Identification via Model Adaptation
- **Authors**: Francois Poh, Anjith George, Sébastien Marcel
- **URL**: [https://arxiv.org/abs/2508.20626](https://arxiv.org/abs/2508.20626)
- **Abstract**:
...
## 68. Flowing Straighter with Conditional Flow Matching for Accurate Speech Enhancement
- **Authors**: Mattias Cross, Anton Ragni
- **URL**: [https://arxiv.org/abs/2508.20584](https://arxiv.org/abs/2508.20584)
- **Abstract**:
...
## 69. A Graph Talks, But Who's Listening? Rethinking Evaluations for Graph-Language Models
...
## 70. MERIT: Maximum-normalized Element-wise Ratio for Language Model Large-batch Training
...
## 71. Towards Mechanistic Defenses Against Typographic Attacks in CLIP
...
## 72. AI and Agile Software Development: A Research Roadmap from the XP2025 Workshop
...
- **URL**: [https://arxiv.org/abs/2508.20563](https://arxiv.org/abs/2508.20563)
- **Abstract**:
...
## 73. Adaptive Federated Distillation for Multi-Domain Non-IID Textual Data
...
## 74. Overview of BioASQ 2025: The Thirteenth BioASQ Challenge on Large-Scale Biomedical Semantic Indexing and Question Answering
- **Authors**: Anastasios Nentidis, Georgios Katsimpras, Anastasia Krithara, Martin Krallinger, Miguel Rodríguez-Ortega, Eduard Rodriguez-López, Natalia Loukachevitch, Andrey Sakhovskiy, Elena Tutubalina, Dimitris Dimitriadis, Grigorios Tsoumakas, George Giannakoulas, Alexandra Bekiaridou, Athanasios Samaras, Giorgio Maria Di Nunzio, Nicola Ferro, Stefano Marchesin, Marco Martinelli, Gianmaria Silvello, Georgios Paliouras
- **URL**: [https://arxiv.org/abs/2508.20554](https://arxiv.org/abs/2508.20554)
- **Abstract**:
...
## 75. MedGR$^2$: Breaking the Data Barrier for Medical Reasoning via Generative Reward Learning
...
## 76. SPGrasp: Spatiotemporal Prompt-driven Grasp Synthesis in Dynamic Scenes
- **Authors**: Yunpeng Mei, Hongjie Cao, Yinqiu Xia, Wei Xiao, Zhaohan Feng, Gang Wang, Jie Chen
- **URL**: [https://arxiv.org/abs/2508.20547](https://arxiv.org/abs/2508.20547)
- **Abstract**:
...
## 77. MM-HSD: Multi-Modal Hate Speech Detection in Videos
- **Authors**: Berta Céspedes-Sarrias, Carlos Collado-Capell, Pablo Rodenas-Ruiz, Olena Hrynenko, Andrea Cavallaro
- **URL**: [https://arxiv.org/abs/2508.20546](https://arxiv.org/abs/2508.20546)
- **Abstract**:
...
## 78. Overview of BioASQ 2024: The twelfth BioASQ challenge on Large-Scale Biomedical Semantic Indexing and Question Answering
...
- **URL**: [https://arxiv.org/abs/2508.20532](https://arxiv.org/abs/2508.20532)
- **Abstract**:
...
## 79. BridgeShield: Enhancing Security for Cross-chain Bridge Applications via Heterogeneous Graph Mining
- **Authors**: Dan Lin, Shunfeng Lu, Ziyan Liu, Jiajing Wu, Junyuan Fang, Kaixin Lin, Bowen Song, Zibin Zheng
- **URL**: [https://arxiv.org/abs/2508.20517](https://arxiv.org/abs/2508.20517)
- **Abstract**:
...
## 80. Languages Still Left Behind: Toward a Better Multilingual Machine Translation Benchmark
- **Authors**: Chihiro Taguchi, Seng Mai, Keita Kurabe, Yusuke Sakai, Georgina Agyei, Soudabeh Eslami, David Chiang
- **URL**: [https://arxiv.org/abs/2508.20511](https://arxiv.org/abs/2508.20511)
- **Abstract**:
...
## 81. CaddieSet: A Golf Swing Dataset with Human Joint Features and Ball Information
- **Authors**: Seunghyeon Jung, Seoyoung Hong, Jiwoo Jeong, Seungwon Jeong, Jaerim Choi, Hoki Kim, Woojin Lee
- **URL**: [https://arxiv.org/abs/2508.20491](https://arxiv.org/abs/2508.20491)
- **Abstract**:
...
## 82. Photonic restricted Boltzmann machine for content generation tasks
- **Authors**: Li Luo, Yisheng Fang, Wanyi Zhang, Zhichao Ruan
- **URL**: [https://arxiv.org/abs/2508.20472](https://arxiv.org/abs/2508.20472)
- **Abstract**:
...
## 83. Dual-Model Weight Selection and Self-Knowledge Distillation for Medical Image Classification
- **Authors**: Ayaka Tsutsumi, Guang Li, Ren Togo, Takahiro Ogawa, Satoshi Kondo, Miki Haseyama
- **URL**: [https://arxiv.org/abs/2508.20461](https://arxiv.org/abs/2508.20461)
- **Abstract**:
...
## 84. Evaluating Differentially Private Generation of Domain-Specific Text
...
- **URL**: [https://arxiv.org/abs/2508.20452](https://arxiv.org/abs/2508.20452)
- **Abstract**:
...
## 85. Towards Mitigating Excessive Forgetting in LLM Unlearning via Entanglement-Aware Unlearning with Proxy Constraint
...
## 86. Uncovering the Spectral Bias in Diagonal State Space Models
- **Authors**: Ruben Solozabal, Velibor Bojkovic, Hilal AlQuabeh, Kentaro Inui, Martin Takáč
- **URL**: [https://arxiv.org/abs/2508.20441](https://arxiv.org/abs/2508.20441)
- **Abstract**:
...
## 87. On Identifying Why and When Foundation Models Perform Well on Time-Series Forecasting Using Automated Explanations and Rating
- **Authors**: Michael Widener, Kausik Lakkaraju, John Aydin, Biplav Srivastava
- **URL**: [https://arxiv.org/abs/2508.20437](https://arxiv.org/abs/2508.20437)
- **Abstract**:
...
## 88. Rethinking Purity and Diversity in Multi-Behavior Sequential Recommendation from the Frequency Perspective
- **Authors**: Yongqiang Han, Kai Cheng, Kefan Wang, Enhong Chen
- **URL**: [https://arxiv.org/abs/2508.20427](https://arxiv.org/abs/2508.20427)
- **Abstract**:
...
## 89. DentalBench: Benchmarking and Advancing LLMs Capability for Bilingual Dentistry Understanding
...
## 90. Assessing local deformation and computing scalar curvature with nonlinear conformal regularization of decoders
- **Authors**: Benjamin Couéraud, Vikram Sunkara, Christof Schütte
- **URL**: [https://arxiv.org/abs/2508.20413](https://arxiv.org/abs/2508.20413)
- **Abstract**:
...
## 91. MPFormer: Adaptive Framework for Industrial Multi-Task Personalized Sequential Retriever
- **Authors**: Yijia Sun, Shanshan Huang, Linxiao Che, Haitao Lu, Qiang Luo, Kun Gai, Guorui Zhou
- **URL**: [https://arxiv.org/abs/2508.20400](https://arxiv.org/abs/2508.20400)
- **Abstract**:
...
## 92. TF-TransUNet1D: Time-Frequency Guided Transformer U-Net for Robust ECG Denoising in Digital Twin
- **Authors**: Shijie Wang, Lei Li
- **URL**: [https://arxiv.org/abs/2508.20398](https://arxiv.org/abs/2508.20398)
- **Abstract**:
...
## 93. Measuring Reasoning Utility in LLMs via Conditional Entropy Reduction
- **Authors**: Xu Guo
...
## 94. Ultra-Low-Latency Spiking Neural Networks with Temporal-Dependent Integrate-and-Fire Neuron Model for Objects Detection
- **Authors**: Chengjun Zhang, Yuhao Zhang, Jie Yang, Mohamad Sawan
- **URL**: [https://arxiv.org/abs/2508.20392](https://arxiv.org/abs/2508.20392)
- **Abstract**:
...
## 95. Graph-R1: Unleashing LLM Reasoning with NP-Hard Graph Problems
...
## 96. Adaptive Root Cause Localization for Microservice Systems with Multi-Agent Recursion-of-Thought
...
## 97. Boosting Skeleton-Driven SMT Solver Fuzzing by Leveraging LLM to Produce Formula Generators
...
## 98. Poison Once, Refuse Forever: Weaponizing Alignment for Injecting Bias in LLMs
...
## 99. Multi-View Graph Convolution Network for Internal Talent Recommendation Based on Enterprise Emails
- **Authors**: Soo Hyun Kim, Jang-Hyun Kim
- **URL**: [https://arxiv.org/abs/2508.20328](https://arxiv.org/abs/2508.20328)
- **Abstract**:
...
## 100. GUARD: Guideline Upholding Test through Adaptive Role-play and Jailbreak Diagnostics for LLMs
...
## 101. Differentially Private Federated Quantum Learning via Quantum Noise
- **Authors**: Atit Pokharel, Ratun Rahman, Shaba Shaon, Thomas Morris, Dinh C. Nguyen
- **URL**: [https://arxiv.org/abs/2508.20310](https://arxiv.org/abs/2508.20310)
- **Abstract**:
...
## 102. Surveying the Operational Cybersecurity and Supply Chain Threat Landscape when Developing and Deploying AI Systems
- **Authors**: Michael R Smith, Joe Ingram
- **URL**: [https://arxiv.org/abs/2508.20307](https://arxiv.org/abs/2508.20307)
- **Abstract**:
...
## 103. Dynamics-Aligned Latent Imagination in Contextual World Models for Zero-Shot Generalization
- **Authors**: Frank Röder, Jan Benad, Manfred Eppe, Pradeep Kr. Banerjee
- **URL**: [https://arxiv.org/abs/2508.20294](https://arxiv.org/abs/2508.20294)
- **Abstract**:
...
## 104. Beacon: Post-Training Quantization with Integrated Grid Selection
- **Authors**: Shihao Zhang, Rayan Saab
- **URL**: [https://arxiv.org/abs/2508.20293](https://arxiv.org/abs/2508.20293)
- **Abstract**:
...
## 105. Objective Value Change and Shape-Based Accelerated Optimization for the Neural Network Approximation
- **Authors**: Pengcheng Xie, Zihao Zhou, Zijian Zhou
- **URL**: [https://arxiv.org/abs/2508.20290](https://arxiv.org/abs/2508.20290)
- **Abstract**:
...
## 106. Network-Level Prompt and Trait Leakage in Local Research Agents
...
## 107. How Multimodal LLMs Solve Image Tasks: A Lens on Visual Grounding, Task Reasoning, and Answer Decoding
...
## 108. SwizzlePerf: Hardware-Aware LLMs for GPU Kernel Performance Optimization
...
## 109. MedNet-PVS: A MedNeXt-Based Deep Learning Model for Automated Segmentation of Perivascular Spaces
...
- **URL**: [https://arxiv.org/abs/2508.20256](https://arxiv.org/abs/2508.20256)
- **Abstract**:
...
## 110. The Mathematician's Assistant: Integrating AI into Research Practice
...
## 111. Validating Generative Agent-Based Models for Logistics and Supply Chain Management Research
...
## 112. A Novel Framework for Automated Explain Vision Model Using Vision-Language Models
...
## 113. The Role of Teacher Calibration in Knowledge Distillation
- **Authors**: Suyoung Kim, Seonguk Park, Junhoo Lee, Nojun Kwak
- **URL**: [https://arxiv.org/abs/2508.20224](https://arxiv.org/abs/2508.20224)
- **Abstract**:
...
## 114. Prompting Strategies for Language Model-Based Item Generation in K-12 Education: Bridging the Gap Between Small and Large Language Models
...
## 115. Collaborating with GenAI: Incentives and Replacements
- **Authors**: Boaz Taitler, Omer Ben-Porat
- **URL**: [https://arxiv.org/abs/2508.20213](https://arxiv.org/abs/2508.20213)
- **Abstract**:
...
## 116. Filter then Attend: Improving attention-based Time Series Forecasting with Spectral Filtering
- **Authors**: Elisha Dayag, Nhat Thanh Van Tran, Jack Xin
- **URL**: [https://arxiv.org/abs/2508.20206](https://arxiv.org/abs/2508.20206)
- **Abstract**:
...
## 117. AI Propaganda factories with language models
...
## 118. Mitigating Hallucinations in Multimodal LLMs via Object-aware Preference Optimization
...
## 119. RelAItionship Building: Analyzing Recruitment Strategies for Participatory AI
- **Authors**: Eugene Kim, Vaibhav Balloli, Berelian Karimian, Elizabeth Bondi-Kelly, Benjamin Fish
- **URL**: [https://arxiv.org/abs/2508.20176](https://arxiv.org/abs/2508.20176)
- **Abstract**:
...
## 120. Navigating the EU AI Act: Foreseeable Challenges in Qualifying Deep Learning-Based Automated Inspections of Class III Medical Devices
- **Authors**: Julio Zanon Diaz, Tommy Brennan, Peter Corcoran
- **URL**: [https://arxiv.org/abs/2508.20144](https://arxiv.org/abs/2508.20144)
- **Abstract**:
...
## 121. UltraEar: a multicentric, large-scale database combining ultra-high-resolution computed tomography and clinical data for ear diseases
...
- **URL**: [https://arxiv.org/abs/2508.20141](https://arxiv.org/abs/2508.20141)
- **Abstract**:
...
## 122. Data-Efficient Point Cloud Semantic Segmentation Pipeline for Unimproved Roads
- **Authors**: Andrew Yarovoi, Christopher R. Valenta
- **URL**: [https://arxiv.org/abs/2508.20135](https://arxiv.org/abs/2508.20135)
- **Abstract**:
...
## 123. Artificial Intelligence for CRISPR Guide RNA Design: Explainable Models and Off-Target Safety
- **Authors**: Alireza Abbaszadeh, Armita Shahlai
- **URL**: [https://arxiv.org/abs/2508.20130](https://arxiv.org/abs/2508.20130)
- **Abstract**:
...
## 124. Improving Liver Disease Diagnosis with SNNDeep: A Custom Spiking Neural Network Using Diverse Learning Algorithms
- **Authors**: Zofia Rudnicka, Janusz Szczepanski, Agnieszka Pregowska
- **URL**: [https://arxiv.org/abs/2508.20125](https://arxiv.org/abs/2508.20125)
- **Abstract**:
...
## 125. Towards Better Correctness and Efficiency in Code Generation
...
## 126. Particle swarm optimization for online sparse streaming feature selection under uncertainty
- **Authors**: Ruiyang Xu
- **URL**: [https://arxiv.org/abs/2508.20123](https://arxiv.org/abs/2508.20123)
- **Abstract**:
...
## 127. Is Artificial Intelligence Reshaping the Landscape of the International Academic Community of Geosciences?
- **Authors**: Liang Li, Yuntian Li, Wenxin Zhao, Shan Ye, Yun Lu
- **URL**: [https://arxiv.org/abs/2508.20117](https://arxiv.org/abs/2508.20117)
- **Abstract**:
...
## 128. Flexible metadata harvesting for ecology using large language models
...
## 129. Deep Reinforcement Learning for Optimal Asset Allocation Using DDPG with TiDE
- **Authors**: Rongwei Liu, Jin Zheng, John Cartlidge
- **URL**: [https://arxiv.org/abs/2508.20103](https://arxiv.org/abs/2508.20103)
- **Abstract**:
...
## 130. A Hierarchical Signal Coordination and Control System Using a Hybrid Model-based and Reinforcement Learning Approach
- **Authors**: Xianyue Peng, Shenyang Chen, H. Michael Zhang
- **URL**: [https://arxiv.org/abs/2508.20102](https://arxiv.org/abs/2508.20102)
- **Abstract**:
...
## 131. Can LLMs Identify Tax Abuse?
